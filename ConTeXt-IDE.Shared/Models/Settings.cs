...
namespace ConTeXt_IDE.Models
{
	public class Settings : Helpers.Bindable
	{
		...
		public int RibbonMarginValue { get => Get(4); set { Set(value); if (App.VM != null) { App.VM.CornerRadius_Ribbon = new(value*2); App.VM.Margin_Ribbon = new(value, 0, value, value); App.VM.Margin_SettingsButton = new(value,0,0,0); } } }
