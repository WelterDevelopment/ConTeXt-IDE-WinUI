...
namespace Monaco.Languages
{
    ...
    {
        [JsonProperty("signatureHelpTriggerCharacters", NullValueHandling = NullValueHandling.Ignore)]
        string[] SignatureHelpTriggerCharacters { get; }

        [JsonProperty("signatureHelpRetriggerCharacters", NullValueHandling = NullValueHandling.Ignore)]
        string[] SignatureHelpRetriggerCharacters { get; }
      
        IAsyncOperation<SignatureHelpResult> ProvideSignatureHelpAsync(IModel model, Position position, SignatureHelpContext context);
