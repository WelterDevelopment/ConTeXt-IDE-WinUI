...
namespace Monaco
{
    public partial class CodeEditor
    {
        ...
        public new event RoutedEventHandler PositionChanged;
...
#pragma warning restore CS0252 // Possible unintended reference comparison; left hand side needs cast
        ...
        private async void ReturnMessage(string opId, object ret)
        {
            ...
            catch (Exception ex) { Debug.WriteLine("ReturnMessageError: " + ex.Message); }
        }
        ...
        internal bool TriggerKeyDown(WebKeyEventArgs args)
        {
            ...
            PositionChanged?.Invoke(this, new RoutedEventArgs());
